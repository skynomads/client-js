...
var ObservableCloudplaneApi = (function () {
    ...
    ObservableCloudplaneApi.prototype.v1ApplicationGet = function (_options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.v1ApplicationGet(_options);
        ...
        return middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)(function (ctx) { return _this.configuration.httpApi.send(ctx); })).
            ...
            return middlewarePostObservable.pipe((0, rxjsStub_2.map)(function (rsp) { return _this.responseProcessor.v1ApplicationGet(rsp); }));
        }));
    };
    ObservableCloudplaneApi.prototype.v1ApplicationNameDelete = function (name, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.v1ApplicationNameDelete(name, _options);
        var middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        ...
        return middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)(function (ctx) { return _this.configuration.httpApi.send(ctx); })).
            ...
            return middlewarePostObservable.pipe((0, rxjsStub_2.map)(function (rsp) { return _this.responseProcessor.v1ApplicationNameDelete(rsp); }));
        }));
    };
    ObservableCloudplaneApi.prototype.v1ApplicationNameGet = function (name, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.v1ApplicationNameGet(name, _options);
        var middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
    ...
    ObservableCloudplaneApi.prototype.v1ApplicationPut = function (application, _options) {
        ...
        return middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)(function (ctx) { return _this.configuration.httpApi.send(ctx); })).
            ...
            return middlewarePostObservable.pipe((0, rxjsStub_2.map)(function (rsp) { return _this.responseProcessor.v1ApplicationPut(rsp); }));
        }));
    };
    ...
    ObservableCloudplaneApi.prototype.v1ExportscheduleGet = function (_options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.v1ExportscheduleGet(_options);
        var middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
