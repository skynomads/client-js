...
var JobApiRequestFactory = (function (_super) {
    ...
    JobApiRequestFactory.prototype.v1ExportPut = function (jobInput, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (jobInput === null || jobInput === undefined) {
                            throw new baseapi_1.RequiredError("JobApi", "v1ExportPut", "jobInput");
                        }
...
var JobApiResponseProcessor = (function () {
    ...
    JobApiResponseProcessor.prototype.v1ExportPut = function (response) {
        return __awaiter(this, void 0, void 0, function () {
