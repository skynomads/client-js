...
var ExportApiRequestFactory = (function (_super) {
    __extends(ExportApiRequestFactory, _super);
    function ExportApiRequestFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ExportApiRequestFactory.prototype.v1ExportGet = function (_options) {
        var _a, _b, _c;
    ...
    ExportApiRequestFactory.prototype.v1ExportNameGet = function (name, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (name === null || name === undefined) {
                            throw new baseapi_1.RequiredError("ExportApi", "v1ExportNameGet", "name");
                        }
    ...
    ExportApiRequestFactory.prototype.v1ExportPut = function (_export, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (_export === null || _export === undefined) {
                            throw new baseapi_1.RequiredError("ExportApi", "v1ExportPut", "_export");
                        }
                        localVarPath = '/v1/export';
    ...
    ExportApiRequestFactory.prototype.v1ExportTargetGet = function (_options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            return __generator(this, function (_d) {
    ...
    ExportApiRequestFactory.prototype.v1ExportTargetNameGet = function (name, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        if (name === null || name === undefined) {
                            throw new baseapi_1.RequiredError("ExportApi", "v1ExportTargetNameGet", "name");
                        }
    ...
    ExportApiRequestFactory.prototype.v1ExportTargetPut = function (exportTarget, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (exportTarget === null || exportTarget === undefined) {
                            throw new baseapi_1.RequiredError("ExportApi", "v1ExportTargetPut", "exportTarget");
                        }
                        localVarPath = '/v1/export/target';
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.PUT);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
    ...
    return ExportApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.ExportApiRequestFactory = ExportApiRequestFactory;
var ExportApiResponseProcessor = (function () {
    function ExportApiResponseProcessor() {
    }
    ...
    ExportApiResponseProcessor.prototype.v1ExportPut = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
    ...
    ExportApiResponseProcessor.prototype.v1ExportTargetPut = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
    ...
    return ExportApiResponseProcessor;
}());
